...
for timestep in [1E-7, 1E-6, 1E-5, 1E-4, 1E-3, 1E-2, 1E-1][::-1]:
    ...
    oscillators = CoupledOscillators('TimeStep_Convergence/Coupled_Oscillators_fourth_order/ConvergeTimestep_%.2E'%timestep,N_oscillators, k, c, dt=timestep)
    ...
    plot_qp_diagram('TimeStep_Convergence/Coupled_Oscillators_fourth_order/ConvergeTimestep_pq%.2E'%timestep, oscillators.get_position_trajectory()[:,0], oscillators.get_velocity_trajectory()[:,0])
    plot_energy_over_time('TimeStep_Convergence/Coupled_Oscillators_fourth_order/ConvergeTimestep_%.2E_energy'%timestep, times, energies)
